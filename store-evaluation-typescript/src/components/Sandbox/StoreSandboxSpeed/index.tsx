...
function StoreSpeed({ point = 0, totalOrder, isLoading, isError, onClickFixSpeed, onClickChatWittUs }: StoreSandboxSpeedtype) {
                                ...
                                <div className={styles.boxLeft__StoreCredibilityWrapper1}>
                                    <div className={styles.boxLeft__boxChart}>
                                        ...
                                        <div className={styles.boxLeft__boxPoint}>
                                            <p className={`${styles.boxLeft_point} ${styles[`${getStoreEvaluationSpeedMessage('color').score_color}`]}`}>{typeof point !== 'number' ? 0 : point}</p>
                                        </div>
                                    </div>
