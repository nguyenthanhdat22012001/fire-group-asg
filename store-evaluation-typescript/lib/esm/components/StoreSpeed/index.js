...
function StoreSpeed({ point = 0, totalOrder, isLoading, isError, onClickFixSpeed, onClickChatWittUs, onClickResync }) {
    var _a, _b, _c;
    ...
    useEffect(() => {
        if (isLoading)
            return;
        if (countPoint >= 100 || countPoint === point)
            return clearInterval(interval.current);
    }, [countPoint, point]);
    useEffect(() => {
        if (isLoading === true && point === null)
            setCountPoint(0);
    }, [isLoading, point]);
    return (React.createElement("div", { className: `${styles.item}` },
        isLoading && !isError && (React.createElement("div", null,
            ...
            React.createElement(SkeletonBodyText, { lines: 10 }))),
            ...
            React.createElement("div", { className: styles.content },
                React.createElement("div", { className: styles.body },
                    React.createElement("div", { className: styles.boxLeft__boxScoreSpeed },
                        React.createElement("div", { className: styles.boxLeft__StoreCredibilityWrapper1 },
                            React.createElement("div", { className: styles.boxLeft__boxChart },
                                ...
                                , { 
                                    // className={styles.boxLeft_progress}
                                    gapDegree: 80, percent: Number(countPoint) || 0, strokeWidth: 10, trailWidth: 10, strokeColor: getStoreEvaluationSpeedMessage('color').color }),
                                React.createElement("div", { className: styles.boxLeft__boxPoint },
                                    React.createElement("p", { className: `${styles.boxLeft_point} ${styles[`${getStoreEvaluationSpeedMessage('color').score_color}`]}` }, countPoint)),
                                React.createElement("div", { className: styles.bgrBackdrop }),
                                React.createElement("div", { className: styles.boxLeft_resync, onClick: onClickResync },
                                    React.createElement(ReEvaluationIcon, null))),
                    ...
                    React.createElement("div", { className: styles.boxRight },
                        ...
                        _a.map((message, index) => (React.createElement("div", { key: message, className: styles.boxRight__row },
